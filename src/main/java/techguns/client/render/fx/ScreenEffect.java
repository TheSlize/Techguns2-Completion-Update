...
public class ScreenEffect implements IScreenEffect {
	...
	public ScreenEffect(String fxTexture, int cols, int rows, int numSprites, RenderType type) {
        super();
